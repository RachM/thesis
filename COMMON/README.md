...
Source for common components and functions used throughout all experiments in the thesis
...
ellipse.m:
  - Calculates the objective function of the Ellipse function.
...
sphere.m:
  - Calculates the objective function of the Sphere problem.

stblrnd.m:
  - Calculates a random number from a Levy distribution.
  - NOTE: 100% Taken from http://math.bu.edu/people/mveillet/html/alphastablepub.html
